...
program main
	...
	type(ftlSingleList) :: o !无限多态双向循环链表
	type(ftlSingleListIterator) :: it !链表迭代器
	integer :: i
	real(kind=4) :: r
	...
	call o%Resize(8,(0.0d0,0.0d0)) !调整长度 增加的节点为复数
	call o%WriteList() !打印链表
	...
	call o%WriteList() !打印链表
	call o%Erase(3) !删除第3个元素
	call o%WriteList() !打印链表
	call o%Insert(2,33) !第2个元素前插入新元素33
	call o%WriteList() !打印链表
	call WriteNode(o%Get(3),"Node") !获取第6个元素值并打印该元素
